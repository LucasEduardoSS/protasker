...
class IntroductionView(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        super().__init__(master, **kwargs)

        boas_vindas_label = ctk.CTkLabel(
            self,
        ...
        primeiros_passos_frame = ctk.CTkFrame(
            self,
            fg_color="transparent",
            width=200
        )
        ...
        primeiros_passos_label = ctk.CTkLabel(
        ...
        passo_criar_pessoa = ctk.CTkLabel(
            primeiros_passos_frame,
            text="1. Registre uma pessoa.",
            font=("Tahoma", 11),
            fg_color="transparent"
        )
        ...
        passo_criar_tarefa = ctk.CTkLabel(
            primeiros_passos_frame,
            text="2. Registre uma tarefa.",
            font=("Tahoma", 11),
            fg_color="transparent"
        )
        ...
        passo_criar_setor = ctk.CTkLabel(
            primeiros_passos_frame,
            text="3. Registre uma setor (opcional).",
            font=("Tahoma", 11),
            fg_color="transparent"
        )
        ...
        passo_gerar_distro = ctk.CTkLabel(
            primeiros_passos_frame,
